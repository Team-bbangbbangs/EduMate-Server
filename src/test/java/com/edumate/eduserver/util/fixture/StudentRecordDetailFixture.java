...
public class StudentRecordDetailFixture {
    ...
    public static StudentRecordDetail detail01(RecordMetadata studentRecord) {
    ...
    public static StudentRecordDetail detail02(RecordMetadata studentRecord) {
        return StudentRecordDetail.create(
    ...
    public static StudentRecordDetail detail03(RecordMetadata studentRecord) {
        return StudentRecordDetail.create(
